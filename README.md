...
accounts
```
deploy account with constructor in console ⬇️
```
Token.deploy("Test Token","tst",18,1e21,{'from':accounts[2]})
```
access methods in deployed contract
```
>>> Token
[<Token Contract '0x1596Ff8ED308a83897a731F3C1e814B19E11D68c'>]

>>> Token[0].transfer(accounts[1],12345)
Transaction sent: 0x43b8fae42b5e00bcb8763f0d79be8edf2244f1afdfc9158b62fa8bbf06965273
  Gas price: 0.0 gwei   Gas limit: 12000000   Nonce: 1
  Token.transfer confirmed   Block: 5   Gas used: 52091 (0.43%)

<Transaction '0x43b8fae42b5e00bcb8763f0d79be8edf2244f1afdfc9158b62fa8bbf06965273'>
